      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
              <a href="/peminjaman" class="nav-link text-white">
            ...
            @can('admin')
            <li>
              <a href="/input" class="nav-link text-white">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#input"/></svg>
                Input
              </a>
            </li>
            <li>
              <a href="/daftarpeminjaman" class="nav-link text-white">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#daftar"/></svg>
                Daftar
              </a>
            </li>
            @endcan
